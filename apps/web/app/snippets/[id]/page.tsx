...
function SnippetDetailPage() {
  ...
  const snippet = useQuery(api.codeSnippets.getSnippetById, { snippetId: snippetId as Id<"snippets"> });
  const comments = useQuery(api.codeSnippets.getComments, { snippetId: snippetId as Id<"snippets"> });
      ...
      <main className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="mb-8 rounded-2xl overflow-hidden border border-[#ffffff0a] bg-[#121218]">
            ...
            <Editor
              height="600px"
              language={LANGUAGE_CONFIG[snippet?.language || 'plaintext']?.monacoLanguage || 'plaintext'}
              value={snippet.code}
              theme="vs-dark"

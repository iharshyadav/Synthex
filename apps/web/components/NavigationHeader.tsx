        ...
        <div className="relative h-16 sm:h-20 flex items-center justify-between">
          ...
          <div className="flex items-center">
            <Link href="/" className="group relative">
              <div className="absolute -inset-4 rounded-xl bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 opacity-0 
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div className="relative hidden sm:block">
                  <h1 className="text-lg sm:text-lg font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 
            ...
            <nav className="px-4 py-4 space-y-2">
              ...
              <SignedOut>
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-200">Upgrade to Pro</span>
                </Link>
              </SignedOut>
            </nav>
          </div>
